...
let initWebRoutes = (app) => {
    ...
    router.get('/api/get-all-specialty', specialtyController.getAllSpeccialty);
    ...
    router.get('/api/get-list-patient-for-doctor', doctorController.getListPatientFormDoctor);
